...
public class DocumentoDerivacion implements Serializable{
	...
	private Date fechamodificacion;
        ...
        public Integer getIddocumentoderivacion() {
            return iddocumentoderivacion;
        }

        public void setIddocumentoderivacion(Integer iddocumentoderivacion) {
            this.iddocumentoderivacion = iddocumentoderivacion;
        }
