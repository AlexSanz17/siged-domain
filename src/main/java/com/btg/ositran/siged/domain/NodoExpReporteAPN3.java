...
public class NodoExpReporteAPN3 {
	...
	public NodoExpReporteAPN3(Integer idExpediente, Integer plazoProceso, String numeroExpediente, String administrado, String asunto, Integer idGrupoProceso){
		this.idExpediente = idExpediente;
		this.plazoProceso = plazoProceso;
		this.numeroExpediente = numeroExpediente;
		this.administrado = administrado;
	...
	public NodoExpReporteAPN3(Integer idExpediente, Integer plazoProceso, String numeroExpediente, String administrado, String asunto, Integer idGrupoProceso, Date fechaCreacion){
		this.idExpediente = idExpediente;
		this.plazoProceso = plazoProceso;
		this.numeroExpediente = numeroExpediente;
		this.administrado = administrado;
