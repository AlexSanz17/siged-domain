...
public class ReporteAPN9 implements Serializable {
	...
	@Column(name="idareapropietario")
	private Integer idAreaPropietario;
	...
	public Integer getIdAreaPropietario() {
		return idAreaPropietario;
	}

	public void setIdAreaPropietario(Integer idAreaPropietario) {
		this.idAreaPropietario = idAreaPropietario;
	}
